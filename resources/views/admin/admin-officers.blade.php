            ...
            <div class="col-md-6">
                <div class="card top-usg overflow-auto">
                    ...
                    <div class="card-body pb-0">
                        <h5 class="card-title">USG OFFICERS <span>| A.Y 2023-2024</span></h5>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card top-usg overflow-auto">
                    ...
                    <div class="card-body pb-0">
                        <h5 class="card-title">CITE <span>| A.Y 2023-2024</span></h5>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card top-usg overflow-auto">
                    ...
                    <div class="card-body pb-0">
                        <h5 class="card-title">CAS <span>| A.Y 2023-2024</span></h5>
            ...
            <div class="col-md-6">
                <div class="card top-usg overflow-auto">
                    ...
                    <div class="card-body pb-0">
                        <h5 class="card-title">CAS <span>| A.Y 2022-2023</span></h5>
